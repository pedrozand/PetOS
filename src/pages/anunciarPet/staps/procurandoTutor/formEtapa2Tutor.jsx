...
import "./CSS/formEtapa2Tutor.css";

export default function FormEtapa2Tutor({ onProximo, onVoltar }) {
  ...
  return (
    <FormBase etapaAtual={2} onProximo={handleProximo} onVoltar={onVoltar}>
      <div className="formulario-conteudo">
        <div className="box-texto-destaque-tut">
          <p>
        ...
        <div className="upload-area-wrapper-tut">
          <h3 className="titulo-upload-img-tut">Fotos do pet</h3>
          <label
            className={`upload-area-tut ${dragOver ? "drag-over-tut" : ""}`}
            onDrop={handleDrop}
          ...
          {erroImagem && (
            <div className="mensagem-erro-2-tut">{erroImagem}</div>
          )}

          <div className="preview-imagens-tut">
            {imagens.map((img, index) => (
              <div className="preview-item-tut" key={index}>
                <img src={img.preview} alt={`Preview ${index}`} />
                <button
                  className="btn-remover-tut"
