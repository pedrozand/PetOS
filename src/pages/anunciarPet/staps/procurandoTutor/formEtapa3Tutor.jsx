...
import "./CSS/formEtapa3Tutor.css";

export default function FormEtapa3Tutor({ onProximo, onVoltar }) {
  ...
  const renderSelectWithIcon = (label, value, setValue, name, options) => {
    ...
    return (
      <div className="etapa3-select-wrapper-tut">
        <label className="etapa3-select-label-tut">
          {label} <span className="etapa3-optional-label-tut">Opcional</span>
        </label>
        <div className="etapa3-select-container-tut">
          <select
            className={`etapa3-custom-select-tut ${
              value === "" ? "placeholder-tut" : ""
            }`}
            value={value}
          ...
          {focusedSelect === name ? (
            <IoIosArrowUp className="etapa3-select-icon-tut" />
          ) : (
            <IoIosArrowDown className="etapa3-select-icon-tut" />
          )}
        </div>
      </div>
    );
  ...
  return (
    <FormBase etapaAtual={3} onProximo={handleProximo} onVoltar={onVoltar}>
      <div className="formulario-conteudo">
        <div className="etapa3-select-group-tut">
