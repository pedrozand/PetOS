  ...
  return (
    ...
    <div className="sidebar-filter">
      ...
      <div className="filter-group">
        ...
        <label className="switch no-bold">
          <input type="checkbox" name="especie" value="gato" defaultChecked />
      ...
      <div className="filter-group">
        <label>Gênero</label>
        <label className="switch no-bold">
          <input type="checkbox" name="genero" value="macho" defaultChecked />
          <span className="slider"></span> Macho
        </label>
        <label className="switch no-bold">
          <input type="checkbox" name="genero" value="femea" defaultChecked />
